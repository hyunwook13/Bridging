...
public extension PostDTO {
    init(from entity: Post) {
        self.uuid             = entity.id
        self.content          = entity.content
        self.createdAt        = Timestamp(date: entity.createdAt)
        self.createdUserID    = entity.createdUserID
        self.imageURL         = entity.imageURL
        self.likeUserID       = entity.likeUserIDs
        self.reportedUserID   = entity.reportedUserIDs
        self.categories       = entity.categories
        self.title            = entity.title
        self.authorNickName   = entity.authorNickName
        self.authorGender     = entity.authorGender
        self.authorAgeGroup   = entity.authorAgeGroup
        self.lastModifed      = entity.lastModified.map { Timestamp(date: $0) }
        self.lastComment      = entity.lastComment
        self.discussionState  = entity.discussionState
        self.votes            = entity.votes.compactMap { VoteDTO(from: $0) }
        self.comments         = entity.comments.compactMap { CommentDTO(from: $0) }
        self.isTemporaryFlag  = entity.isTemporary
    }
}
...
public extension PostDTO {
    func toEntity() -> Post? {
        ...
        return Post(
            ...
            lastModified: lastModifed?.dateValue(),
            lastComment: lastComment,
            discussionState: discussionState,
            votes: votes.compactMap { $0.toEntity() },
            comments: comments.compactMap { $0.toEntity() },
            isTemporary: isTemporaryFlag
        )
    }
}
