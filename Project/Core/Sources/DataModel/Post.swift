...
//        self._uuid = /*nil*/
    ...
    static var empty = Post(content: "", createdUserID: "", likeUserID: [], reportedUserID: [], comment: [], vote: [], categories: [], title: "", authorNickName: "", authorGender: .man, authorAgeGroup: .teen)
}
